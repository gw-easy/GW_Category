...
//    statusBarManager
    ...
    if (@available(iOS 13.0, *)) {
        statusHeight = [[UIApplication sharedApplication].delegate window].windowScene.statusBarManager.statusBarFrame.size.height;
    }else{
        statusHeight = [UIApplication sharedApplication].statusBarFrame.size.height;
    }
    statusHeight = statusHeight>0?statusHeight:(IS_HAS_SafeArea_GW ? 44 : 20);
